class NetworkPlayer {
    ...
    constructor(window_manager, player_class, name, x=0, y=0, scale=0) {
        if(!(this.#_animation_profile = AnimationProfiles[player_class + "AnimProfile"])) {
            throw new Error("Trying to load unloadable class.");
            return undefined;
        }
        this.#_win = window_manager;
        this.#_win.ssm.load(this.#_animation_profile.moving_filename, name + "Movement", this.#_animation_profile.moving_sprite_width, this.#_animation_profile.moving_sprite_height, this.#_animation_profile.moving_sprite_rows, this.#_animation_profile.moving_sprite_columns);
        this.#_win.ssm.load(this.#_animation_profile.attacking_filename, name + "Attack", this.#_animation_profile.attacking_sprite_width, this.#_animation_profile.attacking_sprite_height, this.#_animation_profile.attacking_sprite_rows, this.#_animation_profile.attacking_sprite_columns);
        this.#_moving_name = name + "Movement";
        this.#_attacking_name = name + "Attack";
        if(!scale){
